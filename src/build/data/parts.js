  ...
  heads: [
    {
      ...
      title: 'Large Cyclops',
      src: '/src/build/data/images/head-big-eye.png',
      type: 'heads',
      cost: 1225.5
    },
    
    {
      ...
      title: 'Friendly Bot',
      src: '/src/build/data/images/head-friendly.png',
      cost: 945.0,
      type: 'heads',
      onSale: true
    },
    {
      ...
      title: 'Shredder',
      src: '/src/build/data/images/head-shredder.png',
      type: 'heads',
      cost: 1275.5
    },
    {
      ...
      title: 'Small Cyclops',
      src: '/src/build/data/images/head-single-eye.png',
      type: 'heads',
      cost: 750.0
    },
    {
      ...
      src: '/src/build/data/images/head-surveillance.png',
      type: 'heads',
      cost: 1255.5
    }
  ],
  arms: [
    {
      ...
      title: 'Articulated',
      src: '/src/build/data/images/arm-articulated-claw.png',
      type: 'arms',
      cost: 275
    },
    {
      ...
      title: 'Two Clawed',
      src: '/src/build/data/images/arm-dual-claw.png',
      type: 'arms',
      cost: 285
    },
    {
      ...
      title: 'Grabber',
      src: '/src/build/data/images/arm-grabber.png',
      type: 'arms',
      cost: 205.5
    },
    {
      ...
      title: 'Propeller',
      src: '/src/build/data/images/arm-propeller.png',
      type: 'arms',
      cost: 230,
      onSale: true
    },
    {
      ...
      title: 'Stubby Claw',
      src: '/src/build/data/images/arm-stubby-claw.png',
      type: 'arms',
      cost: 125
    }
  ],
  torsos: [
    {
      ...
      src: '/src/build/data/images/torso-flexible-gauged.png',
      type: 'torsos',
      cost: 1575
    },
    {
      ...
      title: 'Gauged',
      src: '/src/build/data/images/torso-gauged.png',
      type: 'torsos',
      cost: 1385
    },
    {
      ...
      title: 'Gauged',
      src: '/src/build/data/images/torso-pouch.png',
      type: 'torsos',
      cost: 785,
      onSale: true
    }
  ...
  bases: [
    {
      ...
      src: '/src/build/data/images/base-double-wheel.png',
      type: 'bases',
      cost: 895
    },
    {
      ...
      title: 'Rocket',
      src: '/src/build/data/images/base-rocket.png',
      type: 'bases',
      cost: 1520.5
    },
    {
      ...
      src: '/src/build/data/images/base-single-wheel.png',
      type: 'bases',
      cost: 1190.5
    },
    {
      ...
      title: 'Spring',
      src: '/src/build/data/images/base-spring.png',
      type: 'bases',
      cost: 1190.5
    },
    {
      ...
      src: '/src/build/data/images/base-triple-wheel.png',
      type: 'bases',
      cost: 700.5
    }
  ]
